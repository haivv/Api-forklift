 ...
 *  post:
 *      summary: "----- 2. -----  로그인"
 *      description: "Check login. <br> Default login: admin1/123 <br/> Output url: /check-login/output <br/> Access Token 만료: 10조 (TEST); Refresh Token 만료: 1일; <br/> 로그인  10조 후 accessToken 재발급하기 위해 /accessTokenAgain에 접속해야 한다" 
 *      parameters:
 *       - name: username
 *         description: "username"
 *         in: formData
 ...
 *             example: "Login fail"
 *        '401':
 *          description: "유저 존재하지 않다 "
 *          schema:
 *           type: object
 *           properties:
 *            message:
 *             type: string
 *             example: "idAcc is not exist"
 */
